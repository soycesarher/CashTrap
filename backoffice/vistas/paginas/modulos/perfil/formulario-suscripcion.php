				...
				<div class="card">
					...
					<div id="collapse1" class="collapse show" data-parent="#accordion">
						...
						<div class="card-body">						
							...
							la página web www.soycesarher.com; los términos y palabras no definidas en el documento de Términos y
					...
					<div class="card-header">
				 	...
				 	<div id="collapse3" class="collapse" data-parent="#accordion">
				 		<div class="card-body">
				 			...
				 			<ol>						
								<li>Promover la compra automática de los productos del FABRICANTE que se realiza a través de la oficina virtual de la página web www.soycesarher.com/backoffice</li>
				 	...
				 	<div id="collapse4" class="collapse" data-parent="#accordion">
				 		<div class="card-body">
				 			...
				 			<ol>						
								<li>Activar al DISTRIBUIDOR O VENDEDOR todos los productos al momento de su primer abono de compra y suscripción en la página web www.soycesarher.com/backoffice</li>
				 	...
				 	<div id="collapse7" class="collapse" data-parent="#accordion">
				 		<div class="card-body">
				 			El DISTRIBUIDOR O VENDEDOR reconoce expresamente los derechos de autor y la propiedad intelectual del FABRICANTE sobre los productos y servicios ofrecidos en la página web www.soycesarher.com y www.soycesarher.com/backoffice, el sistema de distribución, los diseños virtuales, las marcas, nombres y enseñas comerciales, material publicitario, y cualquier otra clase de propiedad intelectual que pertenece al FABRICANTE. 
				 		</div>
				 	</div>
				 	...
				 	<div id="collapse9" class="collapse" data-parent="#accordion">
				 		...
				 		<ul>
							...
							<li><b>LÍNEA DESCENDIENTE:</b> Es la ubicación que toman las personas que usted o su equipo de trabajo han ingresado al sistema de Cashtrap. Estás líneas descendientes se organizan en una matriz de múltiplos de 4, es decir, la primera línea descendiente tiene 4 personas, la segunda línea descendiente tiene 16 personas, la tercera línea descendiente tiene 64 personas y la última línea tiene 256 personas.</li>
							<li><b>BACKOFFICE:</b> Es la plataforma virtual que Cashtrap le ofrece para poder visualizar los productos que usted adquiere, administrar y cobrar sus comisiones, resolver inquietudes e informarse acerca del crecimiento de su equipo de trabajo.</li>
							<li><b>EQUIPO DE TRABAJO:</b> Son las personas que ingresan a su línea descendiente de manera directa o indirecta.</li>
							<li><b>INGRESO DIRECTO:</b> Es la venta que usted realiza a las personas para que se suscriban a Cashtrap</li>
							<li><b>INGRESO POR DERRAME:</b> Este sucede cuando las personas que están en su línea descendiente venden la suscripción a Cashtrap</li>
					...
					echo'<script>
						...
						swal({
								type:"error",
							  	...
							  	text: "Ocurrió un error al momento de activar la suscripción, enviar un correo a info@cashtrap.com si han hecho algún desembolso de su dinero",
							  	showConfirmButton: true,
								confirmButtonText: "Cerrar"
